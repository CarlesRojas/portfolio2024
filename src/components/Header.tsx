                    ...
                    <ul className="relative w-full h-full flex flex-wrap items-center justify-center gap-2 sm:gap-4">
                        {links.map((link) => (
                            <li className="flex items-center justify-center relative" key={link}>
                                <a
                                    className={`flex items-center justify-center text-sm font-medium px-4 py-3 text-gray-500 hover:text-gray-950 transition dark:text-gray-400 dark:hover:text-gray-200 ${
